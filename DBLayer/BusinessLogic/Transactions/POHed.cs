...
namespace DBLayer
{
    public partial class POHed : ITransaction
    {
        ...
        public List<PODet> GetDetails(InventorySalesDebtorsSystemEntities DB, string PONo)
        {
            return DB.PODets.Where(p => p.ReferenceNo == PONo).ToList();
        }
    }
}
