...
namespace DBLayer
{
    public partial class GRNHed : ITransaction
    {
        ...
        public List<GRNDet> GetDetails(InventorySalesDebtorsSystemEntities DB, string GRNNo)
        {
            return DB.GRNDets.Where(p => p.ReferenceNo == GRNNo).ToList();
        }
    }
}
