...
namespace DBLayer
{
    public partial class ProductionPlanHed : ITransaction
    {
        ...
        public bool Add(InventorySalesDebtorsSystemEntities DB)
        {
            try
            {
                DB.ProductionPlanHeds.AddObject(this);
                return true;
            }
            catch (Exception e)
            {
        ...
        //public List<pro> GetDetails(InventorySalesDebtorsSystemEntities DB, string QuotationNo)
        //{
